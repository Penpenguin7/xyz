...
##      FLAGS.output_dir)
  pipeline_output = pipeline.load_pipeline(pipeline_instance, pipeline.tf_record_iterator(FLAGS.input, pipeline_instance.input_type))
  print '\n hey'
  train_track = pipeline_output['training_drum_tracks']
  eval_track = pipeline_output['eval_drum_tracks']

  f = open('/home/duong/drum_text.txt','w')
  f.write(str(pipeline_output))
  f.close()
